...
public class JdProveedor extends javax.swing.JDialog {
    ...
    private void paintForm() {
        if (jTable1.getSelectedRow() != -1) {
            ...
            JpCompra.jTextField1.setText("");
            JpCompra.jTextField1.setText(pe.getNombre() + "");
            JpCompra compraNuevo = new JpCompra();
    ...
    private void paintTable(ProveedorModel tableModel) {
