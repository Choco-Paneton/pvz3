...
public class ButtonClass extends JButton implements MouseListener, MouseMotionListener {
    ...
    private Font f = new Font("Century Gothic", Font.BOLD, 14);
