...
public class EncryptorAesGcmPassword {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encryptedTextBase642 = EncryptorAesGcmPassword.encrypt(pText.getBytes(UTF_8), PASSWORD);
        System.out.println(String.format(OUTPUT_FORMAT, "Input (base64)", encryptedTextBase642));

        // if password not match.
        // javax.crypto.AEADBadTagException: Tag mismatch!
        //String decryptedText = EncryptorAesGcmPassword.decrypt(encryptedTextBase64, "other password");

        String decryptedText = EncryptorAesGcmPassword.decrypt(encryptedTextBase642, PASSWORD);
